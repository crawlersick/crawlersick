...
public class connected extends HttpServlet{
	...
	*/
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException
	{
		...
		log.info("+++++++++++++connected , id is : "+presence.clientId());
		for(String tempid : ChatSev.chatids)
		{
			log.info("sent channel using client id "+tempid);
			channelService.sendMessage(new ChannelMessage(tempid, "Client number"+presence.clientId()+" Connected!"));
		}
